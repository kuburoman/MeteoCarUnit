...
public class FormulaInterpreter {
    ...
    private Node parseExpression(ArrayList<String> expParts){
        ...
        for (String part : expParts) {
            ...
            if(inBraces){
                ...
                Node newNode = null;
                switch (part) {
                    case "+": newNode = new Plus(); break;
                    case "-": newNode = new Minus(); break;
                    case "*": newNode = new Multiply(); break;
                    case "/": newNode = new Divide(); break;
                    case "A": newNode = new A(this); break;
                    case "B": newNode = new B(this); break;
                    case "C": newNode = new C(this); break;
                    case "D": newNode = new D(this); break;
                    default:  newNode = new Number(part);
                }
        ...
        // debug
        /*System.out.print("parsed to nodes: ");
        for (Node n : expNodes) {
            System.out.println("Tree trace: "+traceTree(n));
        }
        System.out.print(" |<end"); System.out.println("");*/
        ...
        if(inBraces){
            ...
            System.out.println("ERROR - Braces don't match");
            return null;
        }
        //System.out.println("Braces removed");
        ...
        do{            
            ...
            for (int i = 0; i < expNodes.size(); i++) {
                if(expNodes.get(i).getCode() == Node.DIVIDE){
            ...
            if(opIndex != null){
                ...
                if(opIndex == 0){ useSpareBefore = true; }
                if(opIndex == expNodes.size()-1){ useSpareAfter = true; }
        ...
        // odstranění operátoru
        //<editor-fold defaultstate="collapsed" desc="KRÁT">
        do{            
            
            // nalezne operátor v listu
            opIndex = null;
            for (int i = 0; i < expNodes.size(); i++) {
                if(expNodes.get(i).getCode() == Node.MULTIPLY){
                    if(((Operator)expNodes.get(i)).isEmpty()){
                        opIndex = i; break;
                    }
                }
        ...
        /*System.out.println("parsed to nodes: ");
        for (Node n : expNodes) {
            System.out.println("Tree trace: "+traceTree(n));
        }
    ...
    public void traceTree(){
        System.out.println("RootTrace: "+traceTree(rootNode, true));
    }
    ...
    public double interpretString(String toInterpret){
        ...
        // TODO - podpora pro různé počty bytů, např. podle vzorce
    ...
    double[] abcdBytes;
    public double getA(){return abcdBytes[0];}
    public double getB(){return abcdBytes[1];}
    public double getC(){return abcdBytes[2];} // TODO - 41 0C na začátku se nepočají, upravit
    public double getD(){return abcdBytes[3];} // TODO - A je tak až třetí byte v pořadí :(
    ...
    private abstract class Node{    
        ...
        boolean isOperator(){ return false; }
    }
    private abstract class Operator extends Node{
        ...
        boolean isEmpty(){ return (child1 == null) && (child2 == null);}
    }
    ...
    //<editor-fold defaultstate="collapsed" desc="A, B, C, D & Number">
